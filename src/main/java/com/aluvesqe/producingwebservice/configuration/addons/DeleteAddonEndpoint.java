...
import io.spring.guides.gs_producing_web_service.DeleteAddonRequest;
...
@Endpoint
public class DeleteAddonEndpoint {
    private static final String NAMESPACE_URI = "http://spring.io/guides/gs-producing-web-service";

    @Autowired
    public DeleteAddonEndpoint() {

    }

    @PayloadRoot(namespace = NAMESPACE_URI, localPart = "deleteAddonRequest")
    @ResponsePayload
    public GetSimpleResponse deleteAddon(@RequestPayload DeleteAddonRequest request) {
        ...
        String endPoint = "/admin_api/addon/delete/" + request.getId();
